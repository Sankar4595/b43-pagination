...
var next_btn = document.querySelector('[for="Next"]');
next_btn.addEventListener('click',()=>{
    let arr = [1,2,3];
    for(let i of arr){
        var ele = document.querySelector(`[for="${i}"]`);
        ele.innerText = Number(ele.innerText)+3;
        console.log(ele.innerText);
    }
});

var pre_btn = document.querySelector('[for="Previous"]');
...
function clicking(e){
    var parent = document.querySelector('.display_screen');
    parent.innerHTML="";
